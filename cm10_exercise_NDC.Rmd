...
```{r}
flights2 %>%
  semi_join(weather, by = "year", "time_hour")
```

```{r}
flights2 %>%
  anti_join(weather, by = "year", "time_hour")
```
...
```{r}
weather %>%
  anti_join(flights2, by = c ("year", "time_hour"))
```
