...
```{r}
#install gapminder and tidyverse after installing plotly. I can make 3D images with plotly. x,y,z-axis
library(plotly)
(p <- gapminder %>% 
...
```{r}
#here the "geom"" option is "type". "~"" means formula.
plot_ly(gapminder, 
        x = ~gdpPercap, 
        y = ~lifeExp, 
        z = FILL_THIS_IN,
